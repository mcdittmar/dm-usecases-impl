...
"""
  ...
  This data is organized such that a single Table contains TimeSeries data for
...
def ztf_summary( infile ):

    outfile = "./output/ztf_results.md"
    ...
    # some hack stuff here.. to separate the TimeSeries for each source
